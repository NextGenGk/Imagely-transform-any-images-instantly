...
export default function FAQPage() {
    ...
    return (
        <main className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-12 px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center text-center text-slate-800 max-w-4xl mx-auto">
                <p className="text-base font-medium text-indigo-600">FAQ</p>
                <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mt-2">Frequently Asked Questions</h1>
                ...
                <div className="max-w-3xl w-full mt-12 flex flex-col gap-4 items-start text-left">
                    {faqsData.map((faq, index) => (
                        <div key={index} className="flex flex-col items-start w-full">
                            ...
                            >
                                <h2 className="text-base font-medium text-slate-900">{faq.question}</h2>
                                <svg
                                    width="18"
                                    height="18"
                                    viewBox="0 0 18 18"
                ...
                {/* CTA Section */}
                <div className="mt-16 text-center bg-gradient-to-r from-indigo-600 to-indigo-700 rounded-2xl p-12 text-white w-full">
                    ...
                    <a
                        href="/sign-up"
                        className="inline-block bg-white text-indigo-600 font-semibold py-3 px-8 rounded-lg hover:bg-indigo-50 transition-colors"
                    >
                        Get Started Free
                    </a>
                </div>
